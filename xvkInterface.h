...
namespace XVK_EXPOSE_NATIVE_VULKAN_FUNCTIONS_NAMESPACE {
	...
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkGetPhysicalDeviceGeneratedCommandsPropertiesNVX ) // VkPhysicalDevice physicalDevice, VkDeviceGeneratedCommandsFeaturesNVX* pFeatures, VkDeviceGeneratedCommandsLimitsNVX* pLimits
	...
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkCreateRenderPass2KHR ) // VkDevice device, const VkRenderPassCreateInfo2KHR* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkRenderPass* pRenderPass
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdBeginRenderPass2KHR ) // VkCommandBuffer commandBuffer, const VkRenderPassBeginInfo*      pRenderPassBegin, const VkSubpassBeginInfoKHR*      pSubpassBeginInfo
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdNextSubpass2KHR ) // VkCommandBuffer commandBuffer, const VkSubpassBeginInfoKHR*      pSubpassBeginInfo, const VkSubpassEndInfoKHR*        pSubpassEndInfo
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdEndRenderPass2KHR ) // VkCommandBuffer commandBuffer, const VkSubpassEndInfoKHR*        pSubpassEndInfo
	...
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkWaitSemaphoresKHR ) // VkDevice device, const VkSemaphoreWaitInfoKHR* pWaitInfo, uint64_t timeout
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkSignalSemaphoreKHR ) // VkDevice device, const VkSemaphoreSignalInfoKHR* pSignalInfo
	...
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdProcessCommandsNVX ) // VkCommandBuffer commandBuffer, const VkCmdProcessCommandsInfoNVX* pProcessCommandsInfo
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdReserveSpaceForCommandsNVX ) // VkCommandBuffer commandBuffer, const VkCmdReserveSpaceForCommandsInfoNVX* pReserveSpaceInfo
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkCreateIndirectCommandsLayoutNVX ) // VkDevice device, const VkIndirectCommandsLayoutCreateInfoNVX* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkIndirectCommandsLayoutNVX* pIndirectCommandsLayout
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkDestroyIndirectCommandsLayoutNVX ) // VkDevice device, VkIndirectCommandsLayoutNVX indirectCommandsLayout, const VkAllocationCallbacks* pAllocator
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkCreateObjectTableNVX ) // VkDevice device, const VkObjectTableCreateInfoNVX* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkObjectTableNVX* pObjectTable
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkDestroyObjectTableNVX ) // VkDevice device, VkObjectTableNVX objectTable, const VkAllocationCallbacks* pAllocator
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkRegisterObjectsNVX ) // VkDevice device, VkObjectTableNVX objectTable, uint32_t objectCount, const VkObjectTableEntryNVX* const*    ppObjectTableEntries, const uint32_t* pObjectIndices
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkUnregisterObjectsNVX ) // VkDevice device, VkObjectTableNVX objectTable, uint32_t objectCount, const VkObjectEntryTypeNVX* pObjectEntryTypes, const uint32_t* pObjectIndices
	...
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdCopyAccelerationStructureNV ) // VkCommandBuffer commandBuffer, VkAccelerationStructureNV dst, VkAccelerationStructureNV src, VkCopyAccelerationStructureModeNV mode
