...
namespace XVK_EXPOSE_NATIVE_VULKAN_FUNCTIONS_NAMESPACE {
	...
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdBeginRenderingKHR ) // VkCommandBuffer                   commandBuffer, const VkRenderingInfoKHR*                           pRenderingInfo
	...
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdSetEvent2KHR ) // VkCommandBuffer                   commandBuffer, VkEvent                                             event, const VkDependencyInfoKHR*                          pDependencyInfo
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdResetEvent2KHR ) // VkCommandBuffer                   commandBuffer, VkEvent                                             event, VkPipelineStageFlags2KHR                            stageMask
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdWaitEvents2KHR ) // VkCommandBuffer                   commandBuffer, uint32_t                                            eventCount, const VkEvent*                     pEvents, const VkDependencyInfoKHR*         pDependencyInfos
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdPipelineBarrier2KHR ) // VkCommandBuffer                   commandBuffer, const VkDependencyInfoKHR*                                pDependencyInfo
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdWriteTimestamp2KHR ) // VkCommandBuffer                   commandBuffer, VkPipelineStageFlags2KHR                            stage, VkQueryPool                                         queryPool, uint32_t                                            query
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkQueueSubmit2KHR ) // VkQueue                           queue, uint32_t                            submitCount, const VkSubmitInfo2KHR*           pSubmits, VkFence           fence
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdWriteBufferMarker2AMD ) // VkCommandBuffer                   commandBuffer, VkPipelineStageFlags2KHR                            stage, VkBuffer                                            dstBuffer, VkDeviceSize                                        dstOffset, uint32_t                                            marker
	...
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdCopyBuffer2KHR ) // VkCommandBuffer commandBuffer, const VkCopyBufferInfo2KHR* pCopyBufferInfo
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdCopyImage2KHR ) // VkCommandBuffer commandBuffer, const VkCopyImageInfo2KHR* pCopyImageInfo
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdCopyBufferToImage2KHR ) // VkCommandBuffer commandBuffer, const VkCopyBufferToImageInfo2KHR* pCopyBufferToImageInfo
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdCopyImageToBuffer2KHR ) // VkCommandBuffer commandBuffer, const VkCopyImageToBufferInfo2KHR* pCopyImageToBufferInfo
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdBlitImage2KHR ) // VkCommandBuffer commandBuffer, const VkBlitImageInfo2KHR* pBlitImageInfo
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdResolveImage2KHR ) // VkCommandBuffer commandBuffer, const VkResolveImageInfo2KHR* pResolveImageInfo
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkGetDeviceBufferMemoryRequirementsKHR ) // VkDevice device, const VkDeviceBufferMemoryRequirementsKHR* pInfo, VkMemoryRequirements2* pMemoryRequirements
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkGetDeviceImageMemoryRequirementsKHR ) // VkDevice device, const VkDeviceImageMemoryRequirementsKHR* pInfo, VkMemoryRequirements2* pMemoryRequirements
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkGetDeviceImageSparseMemoryRequirementsKHR ) // VkDevice device, const VkDeviceImageMemoryRequirementsKHR* pInfo, uint32_t* pSparseMemoryRequirementCount, VkSparseImageMemoryRequirements2* pSparseMemoryRequirements
