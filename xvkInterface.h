...
namespace XVK_EXPOSE_NATIVE_VULKAN_FUNCTIONS_NAMESPACE {
	...
	#ifdef VK_ENABLE_BETA_EXTENSIONS
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkGetPhysicalDeviceVideoCapabilitiesKHR ) // VkPhysicalDevice physicalDevice, const VkVideoProfileKHR* pVideoProfile, VkVideoCapabilitiesKHR* pCapabilities
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkGetPhysicalDeviceVideoFormatPropertiesKHR ) // VkPhysicalDevice physicalDevice, const VkPhysicalDeviceVideoFormatInfoKHR* pVideoFormatInfo, uint32_t* pVideoFormatPropertyCount, VkVideoFormatPropertiesKHR* pVideoFormatProperties
	#endif
	...
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkGetPhysicalDeviceToolProperties ) // VkPhysicalDevice physicalDevice, uint32_t* pToolCount, VkPhysicalDeviceToolProperties* pToolProperties
	...
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkGetPhysicalDeviceFragmentShadingRatesKHR ) // VkPhysicalDevice physicalDevice, uint32_t* pFragmentShadingRateCount, VkPhysicalDeviceFragmentShadingRateKHR* pFragmentShadingRates
	...
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkGetPhysicalDeviceToolPropertiesEXT ) // VkPhysicalDevice physicalDevice, uint32_t* pToolCount, VkPhysicalDeviceToolProperties* pToolProperties
	...
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkAcquireDrmDisplayEXT ) // VkPhysicalDevice physicalDevice, int32_t drmFd, VkDisplayKHR display
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkGetDrmDisplayEXT ) // VkPhysicalDevice physicalDevice, int32_t drmFd, uint32_t connectorId, VkDisplayKHR* display
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkAcquireWinrtDisplayNV ) // VkPhysicalDevice physicalDevice, VkDisplayKHR display
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkGetWinrtDisplayNV ) // VkPhysicalDevice physicalDevice, uint32_t deviceRelativeId, VkDisplayKHR* pDisplay
	...
	#ifdef VK_ENABLE_BETA_EXTENSIONS
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkCreateVideoSessionKHR ) // VkDevice device, const VkVideoSessionCreateInfoKHR* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkVideoSessionKHR* pVideoSession
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkDestroyVideoSessionKHR ) // VkDevice device, VkVideoSessionKHR videoSession, const VkAllocationCallbacks* pAllocator
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkGetVideoSessionMemoryRequirementsKHR ) // VkDevice device, VkVideoSessionKHR videoSession, uint32_t* pVideoSessionMemoryRequirementsCount, VkVideoGetMemoryPropertiesKHR* pVideoSessionMemoryRequirements
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkBindVideoSessionMemoryKHR ) // VkDevice device, VkVideoSessionKHR videoSession, uint32_t videoSessionBindMemoryCount, const VkVideoBindMemoryKHR* pVideoSessionBindMemories
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkCreateVideoSessionParametersKHR ) // VkDevice device, const VkVideoSessionParametersCreateInfoKHR* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkVideoSessionParametersKHR* pVideoSessionParameters
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkUpdateVideoSessionParametersKHR ) // VkDevice device, VkVideoSessionParametersKHR videoSessionParameters, const VkVideoSessionParametersUpdateInfoKHR* pUpdateInfo
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkDestroyVideoSessionParametersKHR ) // VkDevice device, VkVideoSessionParametersKHR videoSessionParameters, const VkAllocationCallbacks* pAllocator
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdBeginVideoCodingKHR ) // VkCommandBuffer commandBuffer, const VkVideoBeginCodingInfoKHR* pBeginInfo
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdEndVideoCodingKHR ) // VkCommandBuffer commandBuffer, const VkVideoEndCodingInfoKHR* pEndCodingInfo
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdControlVideoCodingKHR ) // VkCommandBuffer commandBuffer, const VkVideoCodingControlInfoKHR* pCodingControlInfo
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdDecodeVideoKHR ) // VkCommandBuffer commandBuffer, const VkVideoDecodeInfoKHR* pFrameInfo
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdEncodeVideoKHR ) // VkCommandBuffer commandBuffer, const VkVideoEncodeInfoKHR* pEncodeInfo
	#endif
	...
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkCreatePrivateDataSlot ) // VkDevice device, const VkPrivateDataSlotCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkPrivateDataSlot* pPrivateDataSlot
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkDestroyPrivateDataSlot ) // VkDevice device, VkPrivateDataSlot privateDataSlot, const VkAllocationCallbacks* pAllocator
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkSetPrivateData ) // VkDevice device, VkObjectType objectType, uint64_t objectHandle, VkPrivateDataSlot privateDataSlot, uint64_t data
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkGetPrivateData ) // VkDevice device, VkObjectType objectType, uint64_t objectHandle, VkPrivateDataSlot privateDataSlot, uint64_t* pData
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdSetEvent2 ) // VkCommandBuffer                   commandBuffer, VkEvent                                             event, const VkDependencyInfo*                             pDependencyInfo
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdResetEvent2 ) // VkCommandBuffer                   commandBuffer, VkEvent                                             event, VkPipelineStageFlags2               stageMask
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdWaitEvents2 ) // VkCommandBuffer                   commandBuffer, uint32_t                                            eventCount, const VkEvent*                     pEvents, const VkDependencyInfo*            pDependencyInfos
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdPipelineBarrier2 ) // VkCommandBuffer                   commandBuffer, const VkDependencyInfo*                             pDependencyInfo
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdWriteTimestamp2 ) // VkCommandBuffer                   commandBuffer, VkPipelineStageFlags2               stage, VkQueryPool                                         queryPool, uint32_t                                            query
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkQueueSubmit2 ) // VkQueue                           queue, uint32_t                            submitCount, const VkSubmitInfo2*              pSubmits, VkFence           fence
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdCopyBuffer2 ) // VkCommandBuffer commandBuffer, const VkCopyBufferInfo2* pCopyBufferInfo
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdCopyImage2 ) // VkCommandBuffer commandBuffer, const VkCopyImageInfo2* pCopyImageInfo
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdCopyBufferToImage2 ) // VkCommandBuffer commandBuffer, const VkCopyBufferToImageInfo2* pCopyBufferToImageInfo
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdCopyImageToBuffer2 ) // VkCommandBuffer commandBuffer, const VkCopyImageToBufferInfo2* pCopyImageToBufferInfo
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdBlitImage2 ) // VkCommandBuffer commandBuffer, const VkBlitImageInfo2* pBlitImageInfo
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdResolveImage2 ) // VkCommandBuffer commandBuffer, const VkResolveImageInfo2* pResolveImageInfo
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdBeginRendering ) // VkCommandBuffer                   commandBuffer, const VkRenderingInfo*                              pRenderingInfo
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdEndRendering ) // VkCommandBuffer                   commandBuffer
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdSetCullMode ) // VkCommandBuffer commandBuffer, VkCullModeFlags cullMode
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdSetFrontFace ) // VkCommandBuffer commandBuffer, VkFrontFace frontFace
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdSetPrimitiveTopology ) // VkCommandBuffer commandBuffer, VkPrimitiveTopology primitiveTopology
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdSetViewportWithCount ) // VkCommandBuffer commandBuffer, uint32_t viewportCount, const VkViewport* pViewports
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdSetScissorWithCount ) // VkCommandBuffer commandBuffer, uint32_t scissorCount, const VkRect2D* pScissors
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdBindVertexBuffers2 ) // VkCommandBuffer commandBuffer, uint32_t firstBinding, uint32_t bindingCount, const VkBuffer* pBuffers, const VkDeviceSize* pOffsets, const VkDeviceSize* pSizes, const VkDeviceSize* pStrides
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdSetDepthTestEnable ) // VkCommandBuffer commandBuffer, VkBool32 depthTestEnable
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdSetDepthWriteEnable ) // VkCommandBuffer commandBuffer, VkBool32 depthWriteEnable
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdSetDepthCompareOp ) // VkCommandBuffer commandBuffer, VkCompareOp depthCompareOp
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdSetDepthBoundsTestEnable ) // VkCommandBuffer commandBuffer, VkBool32 depthBoundsTestEnable
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdSetStencilTestEnable ) // VkCommandBuffer commandBuffer, VkBool32 stencilTestEnable
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdSetStencilOp ) // VkCommandBuffer commandBuffer, VkStencilFaceFlags faceMask, VkStencilOp failOp, VkStencilOp passOp, VkStencilOp depthFailOp, VkCompareOp compareOp
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdSetRasterizerDiscardEnable ) // VkCommandBuffer commandBuffer, VkBool32 rasterizerDiscardEnable
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdSetDepthBiasEnable ) // VkCommandBuffer commandBuffer, VkBool32 depthBiasEnable
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdSetPrimitiveRestartEnable ) // VkCommandBuffer commandBuffer, VkBool32 primitiveRestartEnable
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkGetDeviceBufferMemoryRequirements ) // VkDevice device, const VkDeviceBufferMemoryRequirements* pInfo, VkMemoryRequirements2* pMemoryRequirements
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkGetDeviceImageMemoryRequirements ) // VkDevice device, const VkDeviceImageMemoryRequirements* pInfo, VkMemoryRequirements2* pMemoryRequirements
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkGetDeviceImageSparseMemoryRequirements ) // VkDevice device, const VkDeviceImageMemoryRequirements* pInfo, uint32_t* pSparseMemoryRequirementCount, VkSparseImageMemoryRequirements2* pSparseMemoryRequirements
	...
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdBeginRenderingKHR ) // VkCommandBuffer                   commandBuffer, const VkRenderingInfo*                              pRenderingInfo
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdEndRenderingKHR ) // VkCommandBuffer                   commandBuffer
	...
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdSetFragmentShadingRateKHR ) // VkCommandBuffer           commandBuffer, const VkExtent2D*                           pFragmentSize, const VkFragmentShadingRateCombinerOpKHR    combinerOps[2]
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkWaitForPresentKHR ) // VkDevice device, VkSwapchainKHR swapchain, uint64_t presentId, uint64_t timeout
	...
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdSetEvent2KHR ) // VkCommandBuffer                   commandBuffer, VkEvent                                             event, const VkDependencyInfo*                             pDependencyInfo
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdResetEvent2KHR ) // VkCommandBuffer                   commandBuffer, VkEvent                                             event, VkPipelineStageFlags2               stageMask
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdWaitEvents2KHR ) // VkCommandBuffer                   commandBuffer, uint32_t                                            eventCount, const VkEvent*                     pEvents, const VkDependencyInfo*            pDependencyInfos
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdPipelineBarrier2KHR ) // VkCommandBuffer                   commandBuffer, const VkDependencyInfo*                             pDependencyInfo
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdWriteTimestamp2KHR ) // VkCommandBuffer                   commandBuffer, VkPipelineStageFlags2               stage, VkQueryPool                                         queryPool, uint32_t                                            query
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkQueueSubmit2KHR ) // VkQueue                           queue, uint32_t                            submitCount, const VkSubmitInfo2*              pSubmits, VkFence           fence
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdWriteBufferMarker2AMD ) // VkCommandBuffer                   commandBuffer, VkPipelineStageFlags2               stage, VkBuffer                                            dstBuffer, VkDeviceSize                                        dstOffset, uint32_t                                            marker
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkGetQueueCheckpointData2NV ) // VkQueue queue, uint32_t* pCheckpointDataCount, VkCheckpointData2NV* pCheckpointData
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdCopyBuffer2KHR ) // VkCommandBuffer commandBuffer, const VkCopyBufferInfo2* pCopyBufferInfo
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdCopyImage2KHR ) // VkCommandBuffer commandBuffer, const VkCopyImageInfo2* pCopyImageInfo
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdCopyBufferToImage2KHR ) // VkCommandBuffer commandBuffer, const VkCopyBufferToImageInfo2* pCopyBufferToImageInfo
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdCopyImageToBuffer2KHR ) // VkCommandBuffer commandBuffer, const VkCopyImageToBufferInfo2* pCopyImageToBufferInfo
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdBlitImage2KHR ) // VkCommandBuffer commandBuffer, const VkBlitImageInfo2* pBlitImageInfo
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdResolveImage2KHR ) // VkCommandBuffer commandBuffer, const VkResolveImageInfo2* pResolveImageInfo
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdTraceRaysIndirect2KHR ) // VkCommandBuffer commandBuffer, VkDeviceAddress indirectDeviceAddress
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkGetDeviceBufferMemoryRequirementsKHR ) // VkDevice device, const VkDeviceBufferMemoryRequirements* pInfo, VkMemoryRequirements2* pMemoryRequirements
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkGetDeviceImageMemoryRequirementsKHR ) // VkDevice device, const VkDeviceImageMemoryRequirements* pInfo, VkMemoryRequirements2* pMemoryRequirements
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkGetDeviceImageSparseMemoryRequirementsKHR ) // VkDevice device, const VkDeviceImageMemoryRequirements* pInfo, uint32_t* pSparseMemoryRequirementCount, VkSparseImageMemoryRequirements2* pSparseMemoryRequirements
	...
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkCreateCuModuleNVX ) // VkDevice device, const VkCuModuleCreateInfoNVX* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkCuModuleNVX* pModule
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkCreateCuFunctionNVX ) // VkDevice device, const VkCuFunctionCreateInfoNVX* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkCuFunctionNVX* pFunction
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkDestroyCuModuleNVX ) // VkDevice device, VkCuModuleNVX module, const VkAllocationCallbacks* pAllocator
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkDestroyCuFunctionNVX ) // VkDevice device, VkCuFunctionNVX function, const VkAllocationCallbacks* pAllocator
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdCuLaunchKernelNVX ) // VkCommandBuffer commandBuffer, const VkCuLaunchInfoNVX* pLaunchInfo
	...
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkDestroyAccelerationStructureNV ) // VkDevice device, VkAccelerationStructureNV accelerationStructure, const VkAllocationCallbacks* pAllocator
	...
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkBindAccelerationStructureMemoryNV ) // VkDevice device, uint32_t bindInfoCount, const VkBindAccelerationStructureMemoryInfoNV* pBindInfos
	...
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdCopyAccelerationStructureNV ) // VkCommandBuffer commandBuffer, VkAccelerationStructureNV dst, VkAccelerationStructureNV src, VkCopyAccelerationStructureModeKHR mode
	...
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkGetAccelerationStructureHandleNV ) // VkDevice device, VkAccelerationStructureNV accelerationStructure, size_t dataSize, void* pData
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdWriteAccelerationStructuresPropertiesNV ) // VkCommandBuffer commandBuffer, uint32_t accelerationStructureCount, const VkAccelerationStructureNV* pAccelerationStructures, VkQueryType queryType, VkQueryPool queryPool, uint32_t firstQuery
	...
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkCreatePrivateDataSlotEXT ) // VkDevice device, const VkPrivateDataSlotCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkPrivateDataSlot* pPrivateDataSlot
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkDestroyPrivateDataSlotEXT ) // VkDevice device, VkPrivateDataSlot privateDataSlot, const VkAllocationCallbacks* pAllocator
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkSetPrivateDataEXT ) // VkDevice device, VkObjectType objectType, uint64_t objectHandle, VkPrivateDataSlot privateDataSlot, uint64_t data
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkGetPrivateDataEXT ) // VkDevice device, VkObjectType objectType, uint64_t objectHandle, VkPrivateDataSlot privateDataSlot, uint64_t* pData
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdSetFragmentShadingRateEnumNV ) // VkCommandBuffer           commandBuffer, VkFragmentShadingRateNV                     shadingRate, const VkFragmentShadingRateCombinerOpKHR    combinerOps[2]
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkGetImageSubresourceLayout2EXT ) // VkDevice device, VkImage image, const VkImageSubresource2EXT* pSubresource, VkSubresourceLayout2EXT* pLayout
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdSetVertexInputEXT ) // VkCommandBuffer commandBuffer, uint32_t vertexBindingDescriptionCount, const VkVertexInputBindingDescription2EXT* pVertexBindingDescriptions, uint32_t vertexAttributeDescriptionCount, const VkVertexInputAttributeDescription2EXT* pVertexAttributeDescriptions
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkGetDeviceSubpassShadingMaxWorkgroupSizeHUAWEI ) // VkDevice device, VkRenderPass renderpass, VkExtent2D* pMaxWorkgroupSize
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdSubpassShadingHUAWEI ) // VkCommandBuffer commandBuffer
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdBindInvocationMaskHUAWEI ) // VkCommandBuffer commandBuffer, VkImageView imageView, VkImageLayout imageLayout
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkGetMemoryRemoteAddressNV ) // VkDevice device, const VkMemoryGetRemoteAddressInfoNV* pMemoryGetRemoteAddressInfo, VkRemoteAddressNV* pAddress
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkGetPipelinePropertiesEXT ) // VkDevice device, const VkPipelineInfoEXT* pPipelineInfo, VkBaseOutStructure* pPipelineProperties
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdSetPatchControlPointsEXT ) // VkCommandBuffer commandBuffer, uint32_t patchControlPoints
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdSetRasterizerDiscardEnableEXT ) // VkCommandBuffer commandBuffer, VkBool32 rasterizerDiscardEnable
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdSetDepthBiasEnableEXT ) // VkCommandBuffer commandBuffer, VkBool32 depthBiasEnable
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdSetLogicOpEXT ) // VkCommandBuffer commandBuffer, VkLogicOp logicOp
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdSetPrimitiveRestartEnableEXT ) // VkCommandBuffer commandBuffer, VkBool32 primitiveRestartEnable
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdSetColorWriteEnableEXT ) // VkCommandBuffer       commandBuffer, uint32_t                                attachmentCount, const VkBool32*   pColorWriteEnables
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdDrawMultiEXT ) // VkCommandBuffer commandBuffer, uint32_t drawCount, const VkMultiDrawInfoEXT* pVertexInfo, uint32_t instanceCount, uint32_t firstInstance, uint32_t stride
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdDrawMultiIndexedEXT ) // VkCommandBuffer commandBuffer, uint32_t drawCount, const VkMultiDrawIndexedInfoEXT* pIndexInfo, uint32_t instanceCount, uint32_t firstInstance, uint32_t stride, const int32_t* pVertexOffset
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkSetDeviceMemoryPriorityEXT ) // VkDevice       device, VkDeviceMemory memory, float          priority
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkGetDescriptorSetLayoutHostMappingInfoVALVE ) // VkDevice device, const VkDescriptorSetBindingReferenceVALVE* pBindingReference, VkDescriptorSetLayoutHostMappingInfoVALVE* pHostMapping
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkGetDescriptorSetHostMappingVALVE ) // VkDevice device, VkDescriptorSet descriptorSet, void** ppData
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkGetShaderModuleIdentifierEXT ) // VkDevice device, VkShaderModule shaderModule, VkShaderModuleIdentifierEXT* pIdentifier
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkGetShaderModuleCreateInfoIdentifierEXT ) // VkDevice device, const VkShaderModuleCreateInfo* pCreateInfo, VkShaderModuleIdentifierEXT* pIdentifier
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkGetFramebufferTilePropertiesQCOM ) // VkDevice device, VkFramebuffer framebuffer, uint32_t* pPropertiesCount, VkTilePropertiesQCOM* pProperties
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkGetDynamicRenderingTilePropertiesQCOM ) // VkDevice device, const VkRenderingInfo* pRenderingInfo, VkTilePropertiesQCOM* pProperties
	...
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdBuildAccelerationStructuresKHR ) // VkCommandBuffer                                    commandBuffer, uint32_t infoCount, const VkAccelerationStructureBuildGeometryInfoKHR* pInfos, const VkAccelerationStructureBuildRangeInfoKHR* const* ppBuildRangeInfos
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdBuildAccelerationStructuresIndirectKHR ) // VkCommandBuffer                  commandBuffer, uint32_t                                           infoCount, const VkAccelerationStructureBuildGeometryInfoKHR* pInfos, const VkDeviceAddress*             pIndirectDeviceAddresses, const uint32_t*                    pIndirectStrides, const uint32_t* const*             ppMaxPrimitiveCounts
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkBuildAccelerationStructuresKHR ) // VkDevice                                           device, VkDeferredOperationKHR deferredOperation, uint32_t infoCount, const VkAccelerationStructureBuildGeometryInfoKHR* pInfos, const VkAccelerationStructureBuildRangeInfoKHR* const* ppBuildRangeInfos
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkCopyAccelerationStructureKHR ) // VkDevice device, VkDeferredOperationKHR deferredOperation, const VkCopyAccelerationStructureInfoKHR* pInfo
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkCopyAccelerationStructureToMemoryKHR ) // VkDevice device, VkDeferredOperationKHR deferredOperation, const VkCopyAccelerationStructureToMemoryInfoKHR* pInfo
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkCopyMemoryToAccelerationStructureKHR ) // VkDevice device, VkDeferredOperationKHR deferredOperation, const VkCopyMemoryToAccelerationStructureInfoKHR* pInfo
	...
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkGetDeviceAccelerationStructureCompatibilityKHR ) // VkDevice device, const VkAccelerationStructureVersionInfoKHR* pVersionInfo, VkAccelerationStructureCompatibilityKHR* pCompatibility
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkGetAccelerationStructureBuildSizesKHR ) // VkDevice                                            device, VkAccelerationStructureBuildTypeKHR                 buildType, const VkAccelerationStructureBuildGeometryInfoKHR*  pBuildInfo, const uint32_t*  pMaxPrimitiveCounts, VkAccelerationStructureBuildSizesInfoKHR*           pSizeInfo
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdTraceRaysKHR ) // VkCommandBuffer commandBuffer, const VkStridedDeviceAddressRegionKHR* pRaygenShaderBindingTable, const VkStridedDeviceAddressRegionKHR* pMissShaderBindingTable, const VkStridedDeviceAddressRegionKHR* pHitShaderBindingTable, const VkStridedDeviceAddressRegionKHR* pCallableShaderBindingTable, uint32_t width, uint32_t height, uint32_t depth
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkCreateRayTracingPipelinesKHR ) // VkDevice device, VkDeferredOperationKHR deferredOperation, VkPipelineCache pipelineCache, uint32_t createInfoCount, const VkRayTracingPipelineCreateInfoKHR* pCreateInfos, const VkAllocationCallbacks* pAllocator, VkPipeline* pPipelines
	...
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdTraceRaysIndirectKHR ) // VkCommandBuffer commandBuffer, const VkStridedDeviceAddressRegionKHR* pRaygenShaderBindingTable, const VkStridedDeviceAddressRegionKHR* pMissShaderBindingTable, const VkStridedDeviceAddressRegionKHR* pHitShaderBindingTable, const VkStridedDeviceAddressRegionKHR* pCallableShaderBindingTable, VkDeviceAddress indirectDeviceAddress
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkCmdSetRayTracingPipelineStackSizeKHR ) // VkCommandBuffer commandBuffer, uint32_t pipelineStackSize
	
	#ifdef VK_USE_PLATFORM_FUCHSIA
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkGetMemoryZirconHandleFUCHSIA ) // VkDevice device, const VkMemoryGetZirconHandleInfoFUCHSIA* pGetZirconHandleInfo, zx_handle_t* pZirconHandle
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkGetMemoryZirconHandlePropertiesFUCHSIA ) // VkDevice device, VkExternalMemoryHandleTypeFlagBits handleType, zx_handle_t zirconHandle, VkMemoryZirconHandlePropertiesFUCHSIA* pMemoryZirconHandleProperties
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkImportSemaphoreZirconHandleFUCHSIA ) // VkDevice device, const VkImportSemaphoreZirconHandleInfoFUCHSIA* pImportSemaphoreZirconHandleInfo
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkGetSemaphoreZirconHandleFUCHSIA ) // VkDevice device, const VkSemaphoreGetZirconHandleInfoFUCHSIA* pGetZirconHandleInfo, zx_handle_t* pZirconHandle
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkCreateBufferCollectionFUCHSIA ) // VkDevice device, const VkBufferCollectionCreateInfoFUCHSIA* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkBufferCollectionFUCHSIA* pCollection
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkSetBufferCollectionImageConstraintsFUCHSIA ) // VkDevice device, VkBufferCollectionFUCHSIA collection, const VkImageConstraintsInfoFUCHSIA* pImageConstraintsInfo
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkSetBufferCollectionBufferConstraintsFUCHSIA ) // VkDevice device, VkBufferCollectionFUCHSIA collection, const VkBufferConstraintsInfoFUCHSIA* pBufferConstraintsInfo
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkDestroyBufferCollectionFUCHSIA ) // VkDevice device, VkBufferCollectionFUCHSIA collection, const VkAllocationCallbacks* pAllocator
	/* VkResult */ XVK_DEF_INTERFACE_FUNC_H( vkGetBufferCollectionPropertiesFUCHSIA ) // VkDevice device, VkBufferCollectionFUCHSIA collection, VkBufferCollectionPropertiesFUCHSIA* pProperties
	#endif
	...
	#ifdef VK_USE_PLATFORM_METAL_EXT
	/* void */ XVK_DEF_INTERFACE_FUNC_H( vkExportMetalObjectsEXT ) // VkDevice device, VkExportMetalObjectsInfoEXT* pMetalObjectsInfo
	#endif
