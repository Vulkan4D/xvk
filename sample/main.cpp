...
// Include GLFW (optional, you may use anything else that supports Vulkan or none if you don't need to display graphics)
...
std::vector<const char*> vulkanRequiredExtensions{}; // extensions from glfw for creating a window are automatically added to this list
...
int main() {
	...
	// Some important Vulkan variables
