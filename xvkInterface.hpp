...
// from Vulkan-Headers Version 129
...
namespace xvk { namespace Interface {
	...
	XVK_INTERFACE_RAW_FUNCTIONS_ACCESSIBILITY:
		...
		/* VkResult */ XVK_DEF_INTERFACE_FUNC( vkCreateRenderPass2KHR ) // VkDevice device, const VkRenderPassCreateInfo2KHR* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkRenderPass* pRenderPass
		/* void */ XVK_DEF_INTERFACE_FUNC( vkCmdBeginRenderPass2KHR ) // VkCommandBuffer commandBuffer, const VkRenderPassBeginInfo*      pRenderPassBegin, const VkSubpassBeginInfoKHR*      pSubpassBeginInfo
		/* void */ XVK_DEF_INTERFACE_FUNC( vkCmdNextSubpass2KHR ) // VkCommandBuffer commandBuffer, const VkSubpassBeginInfoKHR*      pSubpassBeginInfo, const VkSubpassEndInfoKHR*        pSubpassEndInfo
		/* void */ XVK_DEF_INTERFACE_FUNC( vkCmdEndRenderPass2KHR ) // VkCommandBuffer commandBuffer, const VkSubpassEndInfoKHR*        pSubpassEndInfo
		...
		/* VkResult */ XVK_DEF_INTERFACE_FUNC( vkWaitSemaphoresKHR ) // VkDevice device, const VkSemaphoreWaitInfoKHR* pWaitInfo, uint64_t timeout
		/* VkResult */ XVK_DEF_INTERFACE_FUNC( vkSignalSemaphoreKHR ) // VkDevice device, const VkSemaphoreSignalInfoKHR* pSignalInfo
