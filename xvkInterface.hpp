...
// from Vulkan-Headers Version 198
...
namespace xvk { namespace Interface {
	...
	XVK_INTERFACE_RAW_FUNCTIONS_ACCESSIBILITY:
		...
		/* void */ XVK_DEF_INTERFACE_FUNC( vkCmdBeginRenderingKHR ) // VkCommandBuffer                   commandBuffer, const VkRenderingInfoKHR*                           pRenderingInfo
		...
		/* void */ XVK_DEF_INTERFACE_FUNC( vkCmdSetEvent2KHR ) // VkCommandBuffer                   commandBuffer, VkEvent                                             event, const VkDependencyInfoKHR*                          pDependencyInfo
		/* void */ XVK_DEF_INTERFACE_FUNC( vkCmdResetEvent2KHR ) // VkCommandBuffer                   commandBuffer, VkEvent                                             event, VkPipelineStageFlags2KHR                            stageMask
		/* void */ XVK_DEF_INTERFACE_FUNC( vkCmdWaitEvents2KHR ) // VkCommandBuffer                   commandBuffer, uint32_t                                            eventCount, const VkEvent*                     pEvents, const VkDependencyInfoKHR*         pDependencyInfos
		/* void */ XVK_DEF_INTERFACE_FUNC( vkCmdPipelineBarrier2KHR ) // VkCommandBuffer                   commandBuffer, const VkDependencyInfoKHR*                                pDependencyInfo
		/* void */ XVK_DEF_INTERFACE_FUNC( vkCmdWriteTimestamp2KHR ) // VkCommandBuffer                   commandBuffer, VkPipelineStageFlags2KHR                            stage, VkQueryPool                                         queryPool, uint32_t                                            query
		/* VkResult */ XVK_DEF_INTERFACE_FUNC( vkQueueSubmit2KHR ) // VkQueue                           queue, uint32_t                            submitCount, const VkSubmitInfo2KHR*           pSubmits, VkFence           fence
		/* void */ XVK_DEF_INTERFACE_FUNC( vkCmdWriteBufferMarker2AMD ) // VkCommandBuffer                   commandBuffer, VkPipelineStageFlags2KHR                            stage, VkBuffer                                            dstBuffer, VkDeviceSize                                        dstOffset, uint32_t                                            marker
		...
		/* void */ XVK_DEF_INTERFACE_FUNC( vkCmdCopyBuffer2KHR ) // VkCommandBuffer commandBuffer, const VkCopyBufferInfo2KHR* pCopyBufferInfo
		/* void */ XVK_DEF_INTERFACE_FUNC( vkCmdCopyImage2KHR ) // VkCommandBuffer commandBuffer, const VkCopyImageInfo2KHR* pCopyImageInfo
		/* void */ XVK_DEF_INTERFACE_FUNC( vkCmdCopyBufferToImage2KHR ) // VkCommandBuffer commandBuffer, const VkCopyBufferToImageInfo2KHR* pCopyBufferToImageInfo
		/* void */ XVK_DEF_INTERFACE_FUNC( vkCmdCopyImageToBuffer2KHR ) // VkCommandBuffer commandBuffer, const VkCopyImageToBufferInfo2KHR* pCopyImageToBufferInfo
		/* void */ XVK_DEF_INTERFACE_FUNC( vkCmdBlitImage2KHR ) // VkCommandBuffer commandBuffer, const VkBlitImageInfo2KHR* pBlitImageInfo
		/* void */ XVK_DEF_INTERFACE_FUNC( vkCmdResolveImage2KHR ) // VkCommandBuffer commandBuffer, const VkResolveImageInfo2KHR* pResolveImageInfo
		/* void */ XVK_DEF_INTERFACE_FUNC( vkGetDeviceBufferMemoryRequirementsKHR ) // VkDevice device, const VkDeviceBufferMemoryRequirementsKHR* pInfo, VkMemoryRequirements2* pMemoryRequirements
		/* void */ XVK_DEF_INTERFACE_FUNC( vkGetDeviceImageMemoryRequirementsKHR ) // VkDevice device, const VkDeviceImageMemoryRequirementsKHR* pInfo, VkMemoryRequirements2* pMemoryRequirements
		/* void */ XVK_DEF_INTERFACE_FUNC( vkGetDeviceImageSparseMemoryRequirementsKHR ) // VkDevice device, const VkDeviceImageMemoryRequirementsKHR* pInfo, uint32_t* pSparseMemoryRequirementCount, VkSparseImageMemoryRequirements2* pSparseMemoryRequirements
	...
	XVK_INTERFACE_ABSTRACTED_FUNCTIONS_ACCESSIBILITY:
		...
		inline void CmdBeginRenderingKHR (VkCommandBuffer                   commandBuffer, const VkRenderingInfoKHR*                           pRenderingInfo) {
		...
		inline void CmdSetEvent2KHR (VkCommandBuffer                   commandBuffer, VkEvent                                             event, const VkDependencyInfoKHR*                          pDependencyInfo) {
			XVK_CHECK_FUNC(vkCmdSetEvent2KHR)
			vkCmdSetEvent2KHR(commandBuffer, event, pDependencyInfo);
		}

		inline void CmdResetEvent2KHR (VkCommandBuffer                   commandBuffer, VkEvent                                             event, VkPipelineStageFlags2KHR                            stageMask) {
			XVK_CHECK_FUNC(vkCmdResetEvent2KHR)
			vkCmdResetEvent2KHR(commandBuffer, event, stageMask);
		}

		inline void CmdWaitEvents2KHR (VkCommandBuffer                   commandBuffer, uint32_t                                            eventCount, const VkEvent*                     pEvents, const VkDependencyInfoKHR*         pDependencyInfos) {
			XVK_CHECK_FUNC(vkCmdWaitEvents2KHR)
			vkCmdWaitEvents2KHR(commandBuffer, eventCount, pEvents, pDependencyInfos);
		}

		inline void CmdPipelineBarrier2KHR (VkCommandBuffer                   commandBuffer, const VkDependencyInfoKHR*                                pDependencyInfo) {
			XVK_CHECK_FUNC(vkCmdPipelineBarrier2KHR)
			vkCmdPipelineBarrier2KHR(commandBuffer, pDependencyInfo);
		}

		inline void CmdWriteTimestamp2KHR (VkCommandBuffer                   commandBuffer, VkPipelineStageFlags2KHR                            stage, VkQueryPool                                         queryPool, uint32_t                                            query) {
			XVK_CHECK_FUNC(vkCmdWriteTimestamp2KHR)
			vkCmdWriteTimestamp2KHR(commandBuffer, stage, queryPool, query);
		}

		inline VkResult QueueSubmit2KHR (VkQueue                           queue, uint32_t                            submitCount, const VkSubmitInfo2KHR*           pSubmits, VkFence           fence) {
			XVK_CHECK_FUNC(vkQueueSubmit2KHR)
			return vkQueueSubmit2KHR(queue, submitCount, pSubmits, fence);
		}

		inline void CmdWriteBufferMarker2AMD (VkCommandBuffer                   commandBuffer, VkPipelineStageFlags2KHR                            stage, VkBuffer                                            dstBuffer, VkDeviceSize                                        dstOffset, uint32_t                                            marker) {
		...
		inline void CmdCopyBuffer2KHR (VkCommandBuffer commandBuffer, const VkCopyBufferInfo2KHR* pCopyBufferInfo) {
			XVK_CHECK_FUNC(vkCmdCopyBuffer2KHR)
			vkCmdCopyBuffer2KHR(commandBuffer, pCopyBufferInfo);
		}

		inline void CmdCopyImage2KHR (VkCommandBuffer commandBuffer, const VkCopyImageInfo2KHR* pCopyImageInfo) {
			XVK_CHECK_FUNC(vkCmdCopyImage2KHR)
			vkCmdCopyImage2KHR(commandBuffer, pCopyImageInfo);
		}

		inline void CmdCopyBufferToImage2KHR (VkCommandBuffer commandBuffer, const VkCopyBufferToImageInfo2KHR* pCopyBufferToImageInfo) {
			XVK_CHECK_FUNC(vkCmdCopyBufferToImage2KHR)
			vkCmdCopyBufferToImage2KHR(commandBuffer, pCopyBufferToImageInfo);
		}

		inline void CmdCopyImageToBuffer2KHR (VkCommandBuffer commandBuffer, const VkCopyImageToBufferInfo2KHR* pCopyImageToBufferInfo) {
			XVK_CHECK_FUNC(vkCmdCopyImageToBuffer2KHR)
			vkCmdCopyImageToBuffer2KHR(commandBuffer, pCopyImageToBufferInfo);
		}

		inline void CmdBlitImage2KHR (VkCommandBuffer commandBuffer, const VkBlitImageInfo2KHR* pBlitImageInfo) {
			XVK_CHECK_FUNC(vkCmdBlitImage2KHR)
			vkCmdBlitImage2KHR(commandBuffer, pBlitImageInfo);
		}

		inline void CmdResolveImage2KHR (VkCommandBuffer commandBuffer, const VkResolveImageInfo2KHR* pResolveImageInfo) {
			XVK_CHECK_FUNC(vkCmdResolveImage2KHR)
			vkCmdResolveImage2KHR(commandBuffer, pResolveImageInfo);
		}

		inline void GetDeviceBufferMemoryRequirementsKHR (const VkDeviceBufferMemoryRequirementsKHR* pInfo, VkMemoryRequirements2* pMemoryRequirements) {
		...
		inline void GetDeviceImageMemoryRequirementsKHR (const VkDeviceImageMemoryRequirementsKHR* pInfo, VkMemoryRequirements2* pMemoryRequirements) {
		...
		inline void GetDeviceImageSparseMemoryRequirementsKHR (const VkDeviceImageMemoryRequirementsKHR* pInfo, uint32_t* pSparseMemoryRequirementCount, VkSparseImageMemoryRequirements2* pSparseMemoryRequirements) {
