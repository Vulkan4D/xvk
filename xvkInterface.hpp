...
// This file was generated via the xvk generator version 0.2.1
// from Vulkan-Headers Version 132
...
namespace xvk { namespace Interface {
	...
	XVK_INTERFACE_RAW_FUNCTIONS_ACCESSIBILITY:
		...
		/* void */ XVK_DEF_INTERFACE_FUNC( vkGetPhysicalDeviceGeneratedCommandsPropertiesNVX ) // VkPhysicalDevice physicalDevice, VkDeviceGeneratedCommandsFeaturesNVX* pFeatures, VkDeviceGeneratedCommandsLimitsNVX* pLimits
	...
	protected: 
		...
		void LoadFunctionPointersInterface() override {
			...
			XVK_LOAD_INSTANCE_FUNC( vkGetPhysicalDeviceGeneratedCommandsPropertiesNVX )
	...
	XVK_INTERFACE_RAW_FUNCTIONS_ACCESSIBILITY:
		...
		/* void */ XVK_DEF_INTERFACE_FUNC( vkCmdProcessCommandsNVX ) // VkCommandBuffer commandBuffer, const VkCmdProcessCommandsInfoNVX* pProcessCommandsInfo
		/* void */ XVK_DEF_INTERFACE_FUNC( vkCmdReserveSpaceForCommandsNVX ) // VkCommandBuffer commandBuffer, const VkCmdReserveSpaceForCommandsInfoNVX* pReserveSpaceInfo
		/* VkResult */ XVK_DEF_INTERFACE_FUNC( vkCreateIndirectCommandsLayoutNVX ) // VkDevice device, const VkIndirectCommandsLayoutCreateInfoNVX* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkIndirectCommandsLayoutNVX* pIndirectCommandsLayout
		/* void */ XVK_DEF_INTERFACE_FUNC( vkDestroyIndirectCommandsLayoutNVX ) // VkDevice device, VkIndirectCommandsLayoutNVX indirectCommandsLayout, const VkAllocationCallbacks* pAllocator
		/* VkResult */ XVK_DEF_INTERFACE_FUNC( vkCreateObjectTableNVX ) // VkDevice device, const VkObjectTableCreateInfoNVX* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkObjectTableNVX* pObjectTable
		/* void */ XVK_DEF_INTERFACE_FUNC( vkDestroyObjectTableNVX ) // VkDevice device, VkObjectTableNVX objectTable, const VkAllocationCallbacks* pAllocator
		/* VkResult */ XVK_DEF_INTERFACE_FUNC( vkRegisterObjectsNVX ) // VkDevice device, VkObjectTableNVX objectTable, uint32_t objectCount, const VkObjectTableEntryNVX* const*    ppObjectTableEntries, const uint32_t* pObjectIndices
		/* VkResult */ XVK_DEF_INTERFACE_FUNC( vkUnregisterObjectsNVX ) // VkDevice device, VkObjectTableNVX objectTable, uint32_t objectCount, const VkObjectEntryTypeNVX* pObjectEntryTypes, const uint32_t* pObjectIndices
		...
		/* void */ XVK_DEF_INTERFACE_FUNC( vkCmdCopyAccelerationStructureNV ) // VkCommandBuffer commandBuffer, VkAccelerationStructureNV dst, VkAccelerationStructureNV src, VkCopyAccelerationStructureModeNV mode
	...
	protected: 
		...
		void LoadFunctionPointersInterface() override {
			...
			XVK_LOAD_DEVICE_FUNC( vkCmdProcessCommandsNVX )
			XVK_LOAD_DEVICE_FUNC( vkCmdReserveSpaceForCommandsNVX )
			XVK_LOAD_DEVICE_FUNC( vkCreateIndirectCommandsLayoutNVX )
			XVK_LOAD_DEVICE_FUNC( vkDestroyIndirectCommandsLayoutNVX )
			XVK_LOAD_DEVICE_FUNC( vkCreateObjectTableNVX )
			XVK_LOAD_DEVICE_FUNC( vkDestroyObjectTableNVX )
			XVK_LOAD_DEVICE_FUNC( vkRegisterObjectsNVX )
			XVK_LOAD_DEVICE_FUNC( vkUnregisterObjectsNVX )
