...
// from Vulkan-Headers Version 182
...
namespace xvk { namespace Interface {
	...
	XVK_INTERFACE_LOADER_RAW_FUNCTIONS_ACCESSIBILITY:
		...
		/* VkResult */ XVK_DEF_INTERFACE_FUNC( vkGetSubpassShadingMaxWorkgroupSizeHUAWEI ) // VkRenderPass renderpass, VkExtent2D* pMaxWorkgroupSize
	...
	protected: 
		...
		void LoadFunctionPointersInterface() {
			...
			XVK_LOAD_GLOBAL_FUNC( vkGetSubpassShadingMaxWorkgroupSizeHUAWEI )
