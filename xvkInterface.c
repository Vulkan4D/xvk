...
namespace XVK_EXPOSE_NATIVE_VULKAN_FUNCTIONS_NAMESPACE {
	...
	XVK_DEF_INTERFACE_FUNC_C( vkGetPhysicalDeviceGeneratedCommandsPropertiesNVX )
	...
	XVK_DEF_INTERFACE_FUNC_C( vkCmdProcessCommandsNVX )
	XVK_DEF_INTERFACE_FUNC_C( vkCmdReserveSpaceForCommandsNVX )
	XVK_DEF_INTERFACE_FUNC_C( vkCreateIndirectCommandsLayoutNVX )
	XVK_DEF_INTERFACE_FUNC_C( vkDestroyIndirectCommandsLayoutNVX )
	XVK_DEF_INTERFACE_FUNC_C( vkCreateObjectTableNVX )
	XVK_DEF_INTERFACE_FUNC_C( vkDestroyObjectTableNVX )
	XVK_DEF_INTERFACE_FUNC_C( vkRegisterObjectsNVX )
	XVK_DEF_INTERFACE_FUNC_C( vkUnregisterObjectsNVX )
