...
namespace XVK_EXPOSE_NATIVE_VULKAN_FUNCTIONS_NAMESPACE {
	...
	XVK_DEF_INTERFACE_FUNC_C( vkGetPhysicalDeviceToolProperties )
	...
	XVK_DEF_INTERFACE_FUNC_C( vkCreatePrivateDataSlot )
	XVK_DEF_INTERFACE_FUNC_C( vkDestroyPrivateDataSlot )
	XVK_DEF_INTERFACE_FUNC_C( vkSetPrivateData )
	XVK_DEF_INTERFACE_FUNC_C( vkGetPrivateData )
	XVK_DEF_INTERFACE_FUNC_C( vkCmdSetEvent2 )
	XVK_DEF_INTERFACE_FUNC_C( vkCmdResetEvent2 )
	XVK_DEF_INTERFACE_FUNC_C( vkCmdWaitEvents2 )
	XVK_DEF_INTERFACE_FUNC_C( vkCmdPipelineBarrier2 )
	XVK_DEF_INTERFACE_FUNC_C( vkCmdWriteTimestamp2 )
	XVK_DEF_INTERFACE_FUNC_C( vkQueueSubmit2 )
	XVK_DEF_INTERFACE_FUNC_C( vkCmdCopyBuffer2 )
	XVK_DEF_INTERFACE_FUNC_C( vkCmdCopyImage2 )
	XVK_DEF_INTERFACE_FUNC_C( vkCmdCopyBufferToImage2 )
	XVK_DEF_INTERFACE_FUNC_C( vkCmdCopyImageToBuffer2 )
	XVK_DEF_INTERFACE_FUNC_C( vkCmdBlitImage2 )
	XVK_DEF_INTERFACE_FUNC_C( vkCmdResolveImage2 )
	XVK_DEF_INTERFACE_FUNC_C( vkCmdBeginRendering )
	XVK_DEF_INTERFACE_FUNC_C( vkCmdEndRendering )
	XVK_DEF_INTERFACE_FUNC_C( vkCmdSetCullMode )
	XVK_DEF_INTERFACE_FUNC_C( vkCmdSetFrontFace )
	XVK_DEF_INTERFACE_FUNC_C( vkCmdSetPrimitiveTopology )
	XVK_DEF_INTERFACE_FUNC_C( vkCmdSetViewportWithCount )
	XVK_DEF_INTERFACE_FUNC_C( vkCmdSetScissorWithCount )
	XVK_DEF_INTERFACE_FUNC_C( vkCmdBindVertexBuffers2 )
	XVK_DEF_INTERFACE_FUNC_C( vkCmdSetDepthTestEnable )
	XVK_DEF_INTERFACE_FUNC_C( vkCmdSetDepthWriteEnable )
	XVK_DEF_INTERFACE_FUNC_C( vkCmdSetDepthCompareOp )
	XVK_DEF_INTERFACE_FUNC_C( vkCmdSetDepthBoundsTestEnable )
	XVK_DEF_INTERFACE_FUNC_C( vkCmdSetStencilTestEnable )
	XVK_DEF_INTERFACE_FUNC_C( vkCmdSetStencilOp )
	XVK_DEF_INTERFACE_FUNC_C( vkCmdSetRasterizerDiscardEnable )
	XVK_DEF_INTERFACE_FUNC_C( vkCmdSetDepthBiasEnable )
	XVK_DEF_INTERFACE_FUNC_C( vkCmdSetPrimitiveRestartEnable )
	XVK_DEF_INTERFACE_FUNC_C( vkGetDeviceBufferMemoryRequirements )
	XVK_DEF_INTERFACE_FUNC_C( vkGetDeviceImageMemoryRequirements )
	XVK_DEF_INTERFACE_FUNC_C( vkGetDeviceImageSparseMemoryRequirements )
	...
	XVK_DEF_INTERFACE_FUNC_C( vkCmdBeginRenderingKHR )
	XVK_DEF_INTERFACE_FUNC_C( vkCmdEndRenderingKHR )
	...
	XVK_DEF_INTERFACE_FUNC_C( vkCmdTraceRaysIndirect2KHR )
	XVK_DEF_INTERFACE_FUNC_C( vkGetDeviceBufferMemoryRequirementsKHR )
	XVK_DEF_INTERFACE_FUNC_C( vkGetDeviceImageMemoryRequirementsKHR )
	XVK_DEF_INTERFACE_FUNC_C( vkGetDeviceImageSparseMemoryRequirementsKHR )
	...
	XVK_DEF_INTERFACE_FUNC_C( vkGetImageSubresourceLayout2EXT )
	...
	XVK_DEF_INTERFACE_FUNC_C( vkGetPipelinePropertiesEXT )
	...
	XVK_DEF_INTERFACE_FUNC_C( vkSetDeviceMemoryPriorityEXT )
	XVK_DEF_INTERFACE_FUNC_C( vkGetDescriptorSetLayoutHostMappingInfoVALVE )
	XVK_DEF_INTERFACE_FUNC_C( vkGetDescriptorSetHostMappingVALVE )
	XVK_DEF_INTERFACE_FUNC_C( vkGetShaderModuleIdentifierEXT )
	XVK_DEF_INTERFACE_FUNC_C( vkGetShaderModuleCreateInfoIdentifierEXT )
	XVK_DEF_INTERFACE_FUNC_C( vkGetFramebufferTilePropertiesQCOM )
	XVK_DEF_INTERFACE_FUNC_C( vkGetDynamicRenderingTilePropertiesQCOM )
	...
	XVK_DEF_INTERFACE_FUNC_C( vkCreateBufferCollectionFUCHSIA )
	XVK_DEF_INTERFACE_FUNC_C( vkSetBufferCollectionImageConstraintsFUCHSIA )
	XVK_DEF_INTERFACE_FUNC_C( vkSetBufferCollectionBufferConstraintsFUCHSIA )
	XVK_DEF_INTERFACE_FUNC_C( vkDestroyBufferCollectionFUCHSIA )
	XVK_DEF_INTERFACE_FUNC_C( vkGetBufferCollectionPropertiesFUCHSIA )
	#endif
	...
	#ifdef VK_USE_PLATFORM_METAL_EXT
	XVK_DEF_INTERFACE_FUNC_C( vkExportMetalObjectsEXT )
	#endif
